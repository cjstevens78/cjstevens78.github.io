  ...
  state = {
    ...
    jobs: [
      { id: "aaaaa",
        ...
        summary: "I am currently working with Croydon Council within the CDS (Croydon Digital Service) department. The role has been varied. Initially, I worked with the CDS team to build a new website which is a PHP based Drupal 8 website run on an Azure DevOps platform. I then split my time between the Croydon site and a wider collaborative project to produce a ‘white label’ version of the Croydon site for distribution to other councils – known as ‘LocalGov’ <a href='https://github.com/localgovdrupal/localgov_base_croydon' target='_blank' rel='noopener noreferrer'>https://github.com/localgovdrupal/localgov_base_croydon</a>. This has been a runaway success with many councils having already taken up the codebase. I work within a multi-disciplinary team and am the sole Front End development and Accessibility expert resource. Croydon work in an Agile way with 2 weekly sprints. I have also been working closely with the Shaw Trust to achieve the required WCAG 2.1 AA accessibility standard. Additionally, I manage a Wordpress site that seeks to engage with Digital businesses in the Croydon area.",
